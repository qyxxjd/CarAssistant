...
public final class Util {
    ...
    public static int getColorByType(int type){
        switch (type){
            case Const.TYPE_FUEL: //加油费
                return R.color.chartreuse_light;
            case Const.TYPE_PARKING: //停车费
                return R.color.blue_light;
            case Const.TYPE_REPAIR: //维修费
                return R.color.orange_light;
            case Const.TYPE_ROAD_TOLL: //过路费
                return R.color.saffron_light;
            case Const.TYPE_PREMIUM: //保险费
                return R.color.pale_red;
            case Const.TYPE_MAINTENANCE: //汽车保养费
                return R.color.green_light;
            case Const.TYPE_EXAMINATION: //汽车年审费
                return R.color.purple_light;
            case Const.TYPE_TRAFFIC_VIOLATION: //交通违章罚款
    ...
    public static String formatMoney(float money){
        return format(Const.FORMAT_MONEY, money);
    }
    public static String formatRMB(float money){
        return format(Const.FORMAT_RMB, money);
    }
    public static String formatOilMess(float oilMess){
        return format(Const.FORMAT_OIL_MESS, oilMess);
    }
